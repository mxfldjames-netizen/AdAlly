  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20 pb-8">
        ...
        {/* CHANGED: Switched from lg:grid-cols-3 to md:grid-cols-3 */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-8 items-start mb-12">
          
          {/* Left Side - Text Content */}
          {/* CHANGED: Switched from lg:col-span-1 to md:col-span-1 */}
          ...
          {/* CHANGED: 
            1. Switched to md:col-span-2
            2. Removed relative/height classes
            3. Added flex utilities to center the new nested container 
          */}
          <div className="md:col-span-2 flex items-start justify-center pt-4 md:pt-0">
            {/* CHANGED: ADDED THIS NEW WRAPPER 
              This div is the new 'sandbox' for the circles.
              It's narrow (max-w-sm), centered, and has a fixed height.
            */}
            <div className="relative h-[240px] w-full max-w-sm">

              {/* Feature Circle 1 - Large (Top Center) */}
              {/* NOTE: Positions are now relative to the 384px 'max-w-sm' container */}
              <div
              ...
              {/* CHANGED: Positioned at left-0 (of the new container) */}
              <div
                className="absolute top-12 left-0 w-18 h-18 sm:w-20 sm:h-20 bg-gradient-to-br from-gray-700 to-gray-900 rounded-full flex flex-col items-center justify-center text-white shadow-lg transition-all duration-500 hover:scale-110 hover:shadow-2xl hover:-rotate-6 cursor-pointer group"
              >
              ...
              {/* CHANGED: Positioned at right-0 (of the new container) */}
              <div
                className="absolute top-12 right-0 w-18 h-18 sm:w-20 sm:h-20 bg-gradient-to-br from-gray-800 to-black rounded-full flex flex-col items-center justify-center text-white shadow-lg transition-all duration-500 hover:scale-110 hover:shadow-2xl hover:rotate-6 cursor-pointer group"
              >
              ...
              {/* CHANGED: Positioned relative to new container */}
              <div
                className="absolute bottom-6 left-12 w-16 h-16 sm:w-18 sm:h-18 bg-gradient-to-br from-black to-gray-700 rounded-full flex flex-col items-center justify-center text-white shadow-lg transition-all duration-500 hover:scale-110 hover:shadow-2xl hover:-rotate-6 cursor-pointer group"
              >
              ...
              {/* CHANGED: Positioned relative to new container */}
              <div
                className="absolute bottom-6 right-12 w-16 h-16 sm:w-18 sm:h-18 bg-gradient-to-br from-gray-900 to-gray-700 rounded-full flex flex-col items-center justify-center text-white shadow-lg transition-all duration-500 hover:scale-110 hover:shadow-2xl hover:rotate-6 cursor-pointer group"
              >
              ...
              {/* CHANGED: Percentages are now relative to the new 'max-w-sm' box */}
              <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-15" xmlns="http://www.w3.org/2000/svg">
                <line x1="50%" y1="15%" x2="10%" y2="40%" stroke="currentColor" strokeWidth="1" className="text-gray-400" />
                <line x1="50%" y1="15%" x2="90%" y2="40%" stroke="currentColor" strokeWidth="1" className="text-gray-400" />
                <line x1="10%" y1="40%" x2="25%" y2="75%" stroke="currentColor" strokeWidth="1" className="text-gray-400" />
                <line x1="90%" y1="40%" x2="75%" y2="75%" stroke="currentColor" strokeWidth="1" className="text-gray-400" />
                <line x1="25%" y1="75%" x2="50%" y2="95%" stroke="currentColor" strokeWidth="1" className="text-gray-400" />
                <line x1="75%" y1="75%" x2="50%" y2="95%" stroke="currentColor" strokeWidth="1" className="text-gray-400" />
              </svg>
            </div>
          </div>
        </div>
